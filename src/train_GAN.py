...
def train_GAN(args, G, D):
    ...
    for epoch in range(1, args.epoch_max+1):
        ...
        train_loss = iteration(args, G, D, train_loader, phase="train")
        valid_loss = iteration(args, G, D, valid_loader, phase="valid")
...
def iteration(args, G, D, data_loader, phase="train"):
    """ iteration function """
